		...
		<div id="container">
			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div class="inner-header wrap">
					...
					<div class="menu-btn d-hide t-hide" onclick="menuToggle()"></div>
					...
					<a class="btn" href="#" title="Book an Event" alt="Book an Event">Book an Event</a>
				...
				<a class="donate-large border-left hide-until-load" href="#">
					<div>
						<h3>Make a donation to the Minster</h3>
